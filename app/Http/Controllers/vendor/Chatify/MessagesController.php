...
class MessagesController extends Controller
{
    ...
    public function __construct()
    {
        ...
        config(['chatify.pusher.key' => isset($settings['pusher_app_key']) ? $settings['pusher_app_key'] : '']);
        config(['chatify.pusher.secret' => isset($settings['pusher_app_secret']) ? $settings['pusher_app_secret'] : '']);
        config(['chatify.pusher.app_id' => isset($settings['pusher_app_id']) ? $settings['pusher_app_id'] : '']);
        config(['chatify.pusher.options.cluster' => isset($settings['pusher_app_cluster']) ? $settings['pusher_app_cluster'] : '']);
    ...
    public function idFetchData(Request $request)
    {
        ...
        return Response::json([
            'favorite' => $favorite,
            'fetch' => $fetch ?? [],
            'user_avatar' => $userAvatar ?? $profile.'avatars/avatar.png',
        ]);
    }
