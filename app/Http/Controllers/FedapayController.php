...
class FedapayController extends Controller
{
    public function planPayWithFedapay(Request $request)
    {
        ...
        // $currency_code =  isset($payment_setting['currency_code']) ? $payment_setting['currency_code'] : 'XOF';
        $currency_code ='XOF';
        $user = Auth::user();
        ...
        if ($plan) {
            ...
            $get_amount = round((float)$plan->{$request->fedapay_payment_frequency . '_price'});
