...
class ReferralProgramController extends Controller
{
    public function index()
    {
        ...
        return view('referral.setting',compact('setting','payRequests','transactions'));
    }
    ...
    public function companyIndex()
    {
        ...
        return view('referral.company' , compact('setting' , 'transactions' , 'paidAmount' , 'transactionsOrder' , 'paymentRequest'));
    }
    ...
    public function requestedAmountSent($id)
    {
        ...
        return view('referral.request_amount' , compact('id' , 'netAmount'));
    }

    public function requestCancel($id)
    {
        $transaction = TransactionOrder::where('req_user_id',$id)->first();
        $transaction->delete();
    ...
    public function requestedAmount($id , $status)
    {
        ...
        if($status == 0)
        {
            ...
            return redirect()->route('referral-program.index')->with('success', __('Request Rejected Successfully.'));
        }
