...
class ContractTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('settings')->with('success', __('Contract Type Successfully Created!'));
    }
    ...
    public function update(Request $request, $id , ContractType $contracttype)
    {
        ...
        if(Auth::user()->id == $contracttype->created_by)
        {
            ...
            return redirect()->route('settings')->with('success', __('Contract Type Successfully Updated!'));
        }
        else
        {
            return redirect()->route('settings')->with('error', __('Permission Denied.'));
    ...
    public function destroy(ContractType $contracttype, $id)
    {
        ...
        if(Auth::user()->id == $contracttype->created_by)
        {
            ...
            return redirect()->route('settings')->with('success', __('Contract Type Successfully Deleted.'));
        }
        else
        {
            return redirect()->route('settings')->with('error', __('Permission Denied.'));
