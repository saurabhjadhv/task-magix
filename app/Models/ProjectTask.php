...
class ProjectTask extends Model
{
    ...
    private static $taskProgress = null;

    // public function taskProgress()
    // {
    //     if (self::$taskProgress === null) {
    //         self::$taskProgress = self::fetchtaskProgress();
    //     }
    ...
    public function taskProgress()
{
    return $this->fetchtaskProgress();
}
    

public function fetchtaskProgress()
{
