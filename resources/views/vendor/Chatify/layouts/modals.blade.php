                  ...
                  <div class="app-modal-body">
                      {{-- Udate profile avatar --}}
                        @if(!empty(Auth::user()->avatar))
                            <div class="avatar av-l upload-avatar-preview chatify-d-flex" style="background-image: url('{{$profile_img.'/'.Auth::user()->avatar}}');">
                            </div>
                        @else
                            <div class="avatar av-l upload-avatar-preview chatify-d-flex" style="background-image: url('{{$profile_img.'/avatars/avatar.png'}}');">
                            </div>
                        @endif
