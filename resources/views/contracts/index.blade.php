...
@section('action-button')
    @if (Auth::user()->type == 'owner')
        <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="{{ route('contractclient.create') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Contract')}}" data-toggle="tooltip">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <h6 class="text-success">{{ $cnt_contract['total'] }}</h6>
                        </div>
