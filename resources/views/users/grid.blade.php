            ...
            <div class="card hover-shadow-lg">
                    ...
                    @else
                        @if($user->is_active == 1)
                            <div class="actions px-4 pb-2">
                                <a href="{{ route('users.info',$user->id) }}" class="action-item mr-3" data-title="{{__('View')}}" data-toggle="tooltip" data-original-title="{{__('View')}}">
                ...
                <div class="card-body border-top">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-auto text-center">
                            <span class="d-block h4 mb-0">{{ $user->open_task_count }}</span>
                ...
                <div class="card-footer">
                    <div class="actions d-flex justify-content-between">
                        ...
                        <a href="#" data-url="{{ route('user.info.popup',[$user->id,'due_task']) }}" data-ajax-popup="true" data-size="md" data-title="{{ $user->name.__("'s Due Tasks")}}" class="action-item">
