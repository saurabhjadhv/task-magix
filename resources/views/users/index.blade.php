...
@section('action-button')
    ...
    @if($allow == true)
        <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-1" data-url="{{ route('add.user.view') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Add Member')}}" data-toggle="tooltip">
    ...
    @endif
<a href="{{ route('logindetails.index') }}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-1" data-title="{{__('User Log')}}" data-toggle="tooltip" >
