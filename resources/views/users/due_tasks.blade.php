                    ...
                    <div class="row mb-3">
                        <div class="col-9">
                            <div class="progress-wrapper">
                                <span class="progress-label text-muted text-sm" data-toggle="tooltip" data-original-title="{{$due_task->project->title}}"><a href="{{ route('projects.tasks.index',$due_task->project->id) }}" class="text-muted">{{ $due_task->title }}</a></span>
