                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($invoice->items as $invoiceitem)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="px-0">
                                                            {{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoiceitem->price)}}
                                                            {{-- {{ App\Models\User::priceFormat($invoiceitem->price) }} --}}
                                                         </td>

                                                        <td class="px-0">
                                                            {{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id, $taxes) }}
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                ...
                                                {{-- @foreach($invoice->items as $item)
                                                    <tr>
                                                        ...
                                                        <td class="px-0">{{ App\Models\User::priceFormat($item->tax()) }}</td>
                                                    </tr>
                                                @endforeach --}}
                                            <tfoot>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right subTotal">
                                                        {{ App\Models\User::priceFormat(round($invoice->getTotal())) }}</td>
                                            ...
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-md-6 order-md-2 mb-4 mb-md-0">
                                                    <div class="d-flex align-items-center justify-content-md-end">
                                                        ...
                                                        <span class="h4 mb-0">  {{ App\Models\User::priceFormat(round($invoice->getTotal())) }}</span>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="card">
                    <ul class="nav nav-pills mt-4" role="tablist">
                        ...
                        @if (isset($payment_detail['is_yookassa_enabled']) && $payment_detail['is_yookassa_enabled'] == 'on')
                            <li class="nav-item ml-4">
                        ...
                        @if (isset($payment_detail['is_xendit_enabled']) && $payment_detail['is_xendit_enabled'] == 'on')
                            <li class="nav-item ml-4">
                        ...
                        @if (isset($payment_detail['is_midtrans_enabled']) && $payment_detail['is_midtrans_enabled'] == 'on')
                            <li class="nav-item ml-4">
                        ...
                        @if (isset($payment_detail['is_fedapay_enabled']) && $payment_detail['is_fedapay_enabled'] == 'on')
                            <li class="nav-item ml-4">
                                <a class="nav-link" data-toggle="tab" href="#fedapay-payment" role="tab"
                                    aria-controls="fedapay" aria-selected="false">{{ __('Fedapay') }}</a>
                            </li>
                        @endif
                        @if (isset($payment_detail['is_paiementpro_enabled']) && $payment_detail['is_paiementpro_enabled'] == 'on')
                            <li class="nav-item ml-4">
                                <a class="nav-link" data-toggle="tab" href="#paiementpro-payment" role="tab"
                                    aria-controls="paiementpro" aria-selected="false">{{ __('Paiement Pro') }}</a>
                            </li>
                        @endif
                        @if (isset($payment_detail['is_nepalste_enabled']) && $payment_detail['is_nepalste_enabled'] == 'on')
                            <li class="nav-item ml-4">
                                <a class="nav-link" data-toggle="tab" href="#nepalste-payment" role="tab"
                                    aria-controls="nepalste" aria-selected="false">{{ __('Nepalste') }}</a>
                            </li>
                        @endif
                        @if (isset($payment_detail['is_payhere_enabled']) && $payment_detail['is_payhere_enabled'] == 'on')
                            <li class="nav-item ml-4">
                                <a class="nav-link" data-toggle="tab" href="#payhere-payment" role="tab"
                                    aria-controls="payhere" aria-selected="false">{{ __('PayHere') }}</a>
                            </li>
                        @endif
                        @if (isset($payment_detail['is_cinetpay_enabled']) && $payment_detail['is_cinetpay_enabled'] == 'on')
                            <li class="nav-item ml-4">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade " id="yookassa-payment" role="tabpanel"
                            aria-labelledby="yookassa-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.yookassa', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="xendit-payment" role="tabpanel"
                            aria-labelledby="xendit-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.xendit', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="midtrans-payment" role="tabpanel"
                            aria-labelledby="midtrans-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.midtrans', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="fedapay-payment" role="tabpanel"
                            aria-labelledby="fedapay-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.fedapay', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="paiementpro-payment" role="tabpanel"
                            aria-labelledby="paiementpro-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.paiementpro', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="nepalste-payment" role="tabpanel"
                            aria-labelledby="nepalste-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.nepalste', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="payhere-payment" role="tabpanel"
                            ...
                            <div class="card-body">
                                <form method="post" action="{{ route('invoice.with.payhere', $invoice->id) }}"
                        ...
                        <div class="tab-pane fade " id="cinetpay-payment" role="tabpanel"
                            aria-labelledby="cinetpay-payment">
                                <div class="card-body">
                                    <form method="post" action="{{ route('invoice.with.cinetpay', $invoice->id) }}"
                ...
                $('#paystack-payment-form').ajaxForm(function(res) {
                    ...
                    if (res.flag == 1) {
                        ...
                        var handler = PaystackPop.setup({
                            key: '{{ $payment_detail['paystack_public_key'] }}',
                            email: res.email,
        ...
        $(document).on("click", "#pay_with_flaterwave", function() {
            ...
            $('#flaterwave-payment-form').ajaxForm(function(res) {
                ...
                if (res.flag == 1) {
                    ...
                    var coupon_id = res.coupon;
                    var API_publicKey = '';
                    if ("{{ $payment_detail['flutterwave_public_key'] }}") {
                        API_publicKey = "{{ $payment_detail['flutterwave_public_key'] }}";
                    }
        ...
        $(document).on("click", "#pay_with_razerpay", function() {
            $('#razorpay-payment-form').ajaxForm(function(res) {
                ...
                if (res.flag == 1) {
                    ...
                    var coupon_id = res.coupon;
                    var API_publicKey = '';
                    if ("{{ $payment_detail['razorpay_public_key'] }}") {
                        API_publicKey = "{{ $payment_detail['razorpay_public_key']}}";
                    }
                    var options = {
