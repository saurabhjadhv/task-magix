...
<div class="d-flex align-items-center justify-content-end mt-2 mt-md-0">
    ...
    @if(Auth::user()->type != 'client')
        @if($allow == true)
            <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="{{ route('projects.create') }}" data-ajax-popup="true" data-size="lg" data-title="{{__('Create Project')}}" data-toggle="tooltip">
        ...
        @endif
    @endif
    <a href="{{route('project.export')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-title="{{__('Export Project Excel')}}" data-toggle="tooltip">
