        ...
        <div class="col-lg-8 order-lg-1">
            <div id="tabs-1" class="tabs-card">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('title', null, ['class' => 'form-control','required'=>'required', 'placeholder' => __('Enter project name')]) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('descriptions', null, ['class' => 'form-control','rows' => '3','data-toggle' => 'autosize', 'placeholder' => __('Enter description')]) }}
                                </div>
                            </div>
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <button type="button" class="btn btn-sm btn-danger rounded-pill" data-confirm="{{__('Are You Sure?')}}|{{__('This action can not be undone. Do you still want to delete it?')}}" data-confirm-yes="document.getElementById('delete-project-{{$project->id}}').submit();">{{__('Delete Project')}}</button>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::number('budget', null, ['class' => 'form-control','required' => 'required','step' =>'0.01','min'=>'0', 'placeholder' => __('Enter project budget')]) }}
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
