                    ...
                    @if (isset($paymentSetting['is_yookassa_enabled']) && $paymentSetting['is_yookassa_enabled'] == 'on')
                        <div data-href="#tabs-21" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Yookassa') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_xendit_enabled']) && $paymentSetting['is_xendit_enabled'] == 'on')
                        <div data-href="#tabs-22" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Xendit') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_midtrans_enabled']) && $paymentSetting['is_midtrans_enabled'] == 'on')
                        <div data-href="#tabs-23" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Midtrans') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_fedapay_enabled']) && $paymentSetting['is_fedapay_enabled'] == 'on')
                        <div data-href="#tabs-24" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Fedapay') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_paiementpro_enabled']) && $paymentSetting['is_paiementpro_enabled'] == 'on')
                        <div data-href="#tabs-25" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Paiement Pro') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_nepalste_enabled']) && $paymentSetting['is_nepalste_enabled'] == 'on')
                        <div data-href="#tabs-26" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Nepalste') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_payhere_enabled']) && $paymentSetting['is_payhere_enabled'] == 'on')
                        <div data-href="#tabs-27" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('PayHere') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
                    @if (isset($paymentSetting['is_cinetpay_enabled']) && $paymentSetting['is_cinetpay_enabled'] == 'on')
                        <div data-href="#tabs-28" class="list-group-item">
                            <div class="media">
                                <i class="fas fa-coins"></i>
                                <div class="media-body ml-3">
                                    <a href="#" class="stretched-link h6 mb-1">{{ __('Cinetpay') }}</a>
                                </div>
                            </div>
                        </div>
                    @endif
        ...
        <div class="col-lg-8 order-lg-1">
                                            ...
                                            <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                                <label class="btn btn-sm btn-primary active">
                                                    <input type="radio" name="banktransfer_payment_frequency"
                                                        ...
                                                        data-price="{{ (isset($payment_setting['currency']) ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}"
                                                        autocomplete="off"
                                                        checked="">{{ __('Monthly Payments') }}<br>
                                                    {{ (isset($payment_setting['currency']) ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}
                                                </label>
                                                <label class="btn btn-sm btn-primary">
                                                    <input type="radio" name="banktransfer_payment_frequency"
                                                        class="payment_frequency" data-from="banktransfer" value="annual"
                                                        data-price="{{ (isset($payment_setting['currency']) ? $paymentSetting['currency'] : '$') . $plan->annual_price }}"
                                                        autocomplete="off">{{ __('Annual Payments') }}<br>
                                                    {{ (isset($payment_setting['currency']) ? $paymentSetting['currency'] : '$') . $plan->annual_price }}
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="banktransfer-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                                <label class="btn btn-sm btn-primary active">
                                                    <input type="radio" name="paypal_payment_frequency"
                                                        ...
                                                        data-price="{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}"
                                                        autocomplete="off"
                                                        checked="">{{ __('Monthly Payments') }}<br>
                                                    {{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}
                                                </label>
                                                <label class="btn btn-sm btn-primary">
                                                    <input type="radio" name="paypal_payment_frequency"
                                                        class="payment_frequency" data-from="paypal" value="annual"
                                                        data-price="{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->annual_price }}"
                                                        autocomplete="off">{{ __('Annual Payments') }}<br>
                                                    {{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->annual_price }}
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-10">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paypal-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="stripe-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="button"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paystack-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="button"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="flaterwave-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="button"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="razorpay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_paytm">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paytm-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_mercado">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="mercado-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_mollie">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="mollie-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_skrill">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="skrill-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="coingate-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paymentwall-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="toyyibpay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_payfast">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="payfast-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_iyzipay">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="iyzipay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_sspay">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="sspay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_paytab">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paytab-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_benefit">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="benefit-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="cashfree-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="aamarpay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_paytr">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paytr-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_yookassa_enabled']) && $paymentSetting['is_yookassa_enabled'] == 'on')
                <div id="tabs-21" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using YooKassa') }}</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="yookassa-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_xendit_enabled']) && $paymentSetting['is_xendit_enabled'] == 'on')
                <div id="tabs-22" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Xendit') }}</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_xendit">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="xendit-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_midtrans_enabled']) && $paymentSetting['is_midtrans_enabled'] == 'on')
                <div id="tabs-23" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Midtrans') }}</h5>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="midtrans-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_fedapay_enabled']) && $paymentSetting['is_fedapay_enabled'] == 'on')
                <div id="tabs-24" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Fedapay') }}</h5>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.get.fedapay') }}" method="post"
                                class="require-validation">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_fedapay">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="fedapay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_paiementpro_enabled']) && $paymentSetting['is_paiementpro_enabled'] == 'on')
                <div id="tabs-25" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Paiement Pro') }}</h5>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.get.paiementpro') }}" method="post"
                                class="require-validation">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="paiementpro-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_nepalste_enabled']) && $paymentSetting['is_nepalste_enabled'] == 'on')
                <div id="tabs-26" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Nepalste') }}</h5>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.get.nepalste') }}" method="post"
                                class="require-validation">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="nepalste-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_payhere_enabled']) && $paymentSetting['is_payhere_enabled'] == 'on')
                <div id="tabs-27" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using PayHere') }}</h5>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.get.payhere') }}" method="post"
                                class="require-validation">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                id="pay_with_payhere">
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="payhere-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
            ...
            @if(isset($paymentSetting['is_cinetpay_enabled']) && $paymentSetting['is_cinetpay_enabled'] == 'on')
                <div id="tabs-28" class="tabs-card d-none">
                    <div class="card">
                        <div class="card-header">
                            <h5 class=" h6 mb-0">{{ __('Pay Using Cinetpay') }}</h5>
                        </div>
                        <div class="card-body">
                            <form role="form" action="{{ route('plan.get.cinetpay') }}" method="post"
                                class="require-validation">
                                @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="text-sm-right">
                                            ...
                                            <button class="btn btn-primary btn-sm rounded-pill" type="submit"
                                                ...
                                                <i class="mdi mdi-cash-multiple mr-1"></i> {{ __('Pay Now') }} (<span
                                                    class="cinetpay-final-price">{{ ($paymentSetting['currency'] ? $paymentSetting['currency'] : '$') . $plan->monthly_price }}</span>)
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function applyCoupon(coupon_code, where) {
            if (coupon_code != null && coupon_code != '') {
                ...
                show_toastr('Error', '{{__('Please Enter Coupon Code.')}}', 'error');
                $('.' + where + '-coupon-tr').hide().find('.' + where + '-coupon-price').text('');
