...
<div class="d-flex align-items-center justify-content-end mt-2 mt-md-0">
    ...
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0" data-title="Project Status" data-toggle="tooltip">
        <a href="#" class="action-item text-dark line_height_auto" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <?php if(Auth::user()->type != 'client'): ?>
        <?php if($allow == true): ?>
            <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="<?php echo e(route('projects.create')); ?>" data-ajax-popup="true" data-size="lg" data-title="<?php echo e(__('Create Project')); ?>" data-toggle="tooltip">
        ...
        <?php endif; ?>
    <?php endif; ?>
    <a href="<?php echo e(route('project.export')); ?>" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-title="<?php echo e(__('Export Project Excel')); ?>" data-toggle="tooltip">
...
<?php if(session('success')): ?>
    <div id="success-message"><?php echo e(session('success')); ?></div>
    <script>
        // Clear session storage when the message is shown
        window.onload = function() {
            var successMessage = document.getElementById('success-message');
            if (successMessage) {
                // Clear session after the message is displayed
                setTimeout(function() {
                    successMessage.innerHTML = '';
                    history.replaceState(null, null, location.href); // Clear the success message from history
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/taskmagix/public_html/in/app/resources/views/projects/index.blade.php ENDPATH**/ ?>