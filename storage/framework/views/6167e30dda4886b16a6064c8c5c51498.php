        ...
        <div class="navbar-user d-lg-none">
            <ul class="navbar-nav flex-row align-items-center navbar_msg_responsive">
                ...
                <?php if (is_impersonating($guard = null)) : ?>
                    <li class="dropdown dash-h-item drp-company rounded-pill">
                        <a class="btn btn-danger btn-sm me-3 rounded-pill"
...
<?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/partials/admin/navbar.blade.php ENDPATH**/ ?>