<?php echo e(Form::model($contracttype, array('route' => array('contract.update', $contracttype->id), 'method' => 'PUT'))); ?>

<div class="row">
    <?php if(Utility::plancheck()['enable_chatgpt'] == 'on'): ?>
        <div class="col-12 col-md-12">
            <div class="text-right">
                <a href="#" class="btn btn-sm btn-primary rounded-pill" data-url="<?php echo e(route('generate',['contract_type'])); ?>" data-ajax-popup-over="true" data-bs-placement="top" data-size="md" title="<?php echo e(__('Generate')); ?>" data-title="<?php echo e(__('Generate contect with AI')); ?>">
...
<?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/contracttype/edit.blade.php ENDPATH**/ ?>