...
<?php $__env->startSection('action-button'); ?>
    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-2" data-url="<?php echo e(route('invoices.create')); ?>" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Create Invoice')); ?>" data-toggle="tooltip">
        <span class="btn-inner--icon"><i class="fas fa-plus"></i></span>
    </a>
    <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle" data-url="<?php echo e(route('invoice.file.import')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Import Invoice CSV file')); ?>" data-toggle="tooltip">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show" id="receive" role="tabpanel" aria-labelledby="receive-tab">
            <div class="row">
                <div class="col-12 pb-4">
                    <span class="text-white font-weight-700"><?php echo e(__('Note :')); ?></span>
                    <span class="text-white"><?php echo e(__('You have got this invoice from client.')); ?></span>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/invoices/index.blade.php ENDPATH**/ ?>