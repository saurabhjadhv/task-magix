            ...
            <div class="col-12">
                <div class="footer pt-5 pb-4 footer-light" id="footer-main">
                    <div class="row text-center align-items-sm-center">
                      <div class="col-sm-12">
                            <span class="text-colr">&copy; <?php echo e(date('Y')); ?>

                                <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Task Magix')); ?>. All Rights Reserved. One XL Info LLP</span>
                    <p>A product by <a class="company-text" href="https://1xl.com/">1XL.COM</a></p>
...
<?php /**PATH D:\Main Projects\TaskMagix\in\app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>