...
<?php if($viewType == 'default'): ?>
    ...
    <div class="message-card" data-id="<?php echo e($id); ?>">
        ...
        <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e(asset('storage/app/public/attachments/'.$attachment[0])); ?>')">
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
...
<?php if($viewType == 'sender'): ?>
    <div class="message-card mc-sender" title="<?php echo e($fullTime); ?>" data-id="<?php echo e($id); ?>">
        ...
        <?php if(@$attachment[2] == 'image'): ?>
        <div class="image-file chat-image" style="margin-top:10px;width: 250px; height: 150px;background-image: url('<?php echo e(asset('storage/app/public/attachments/'.$attachment[0])); ?>')">
        </div>
        <?php endif; ?>
    </div>
<?php endif; ?>
<?php /**PATH /home3/taskmagix/public_html/in/app/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>