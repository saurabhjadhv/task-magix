...
<div class="nav-application clearfix">
    ...
    <?php if(Auth::user()->type != 'admin'): ?>
        ...
        <?php endif; ?>
        <?php if(Auth::user()->type != 'client'): ?>
            <a href="<?php echo e(route('users')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('users*') || request()->is('logindetails*') ? 'active' : ''); ?>">
    ...
    <?php if(\Auth::user()->type == 'admin'): ?>
        ...
        <a href="<?php echo e(route('plans.index')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('plans*') ? 'active' : ''); ?>">
            ...
            <span class="btn-inner--icon d-block pt-2"><?php echo e(__('Manage Plans')); ?></span>
        </a>
...
<?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/partials/admin/sidebar.blade.php ENDPATH**/ ?>