        ...
        <div class="bg-neutral rounded-pill d-inline-block">
            <div class="input-group input-group-sm input-group-merge input-group-flush">
                ...
                <input type="text" id="keyword" class="form-control form-control-flush"
                    placeholder="<?php echo e(__('Search by Name or Skill')); ?>">
            </div>
        </div>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
    ...
    <?php else: ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h3 font-weight-bold mb-0 "><?php echo e($home_data['total_project']['total']); ?></span>
                                <br>
                            </div>
                            <div class="col-auto">
                                <div class="progress-circle progress-sm"
                                    data-progress="<?php echo e($home_data['total_project']['percentage']); ?>"
                                    data-text="<?php echo e($home_data['total_project']['percentage']); ?>%" data-color="primary">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="progress-circle progress-sm"
                                    data-progress="<?php echo e($home_data['total_task']['percentage']); ?>"
                                    data-text="<?php echo e($home_data['total_task']['percentage']); ?>%" data-color="info"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="progress-circle progress-sm"
                                    data-progress="<?php echo e($home_data['total_expense']['percentage']); ?>"
                                    data-text="<?php echo e($home_data['total_expense']['percentage']); ?>%" data-color="warning">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row align-items-center mb-4">
                                <div class="col-auto">
                                    <div class="progress-circle progress-sm" data-progress="<?php echo e($val['percentage']); ?>"
                                        data-color="<?php echo e(\App\Models\Project::$status_color[$status]); ?>"></div>
                                </div>
                                <div class="col">
                            ...
                            <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col">
                                    <span class="badge badge-dot badge-lg h6">
                                        <i
                                            class="bg-<?php echo e(\App\Models\Project::$status_color[$status]); ?>"></i><?php echo e($val['total']); ?>
            ...
            <?php if(Auth::user()->type != 'client'): ?>
                <?php if(isset($users->storage_limit) && isset($user_plan)): ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="image-avtar">
                                                ...
                                                <?php if($due_project->image): ?>
                                                    <img src="<?php echo e($logo_path.$due_project->image); ?>" alt="<?php echo e($due_project->title); ?>"  class="avatar rounded-circle" />
                                                <?php else: ?>
                                ...
                                <table class="table align-items-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Project')); ?>
                                            ...
                                            <tr>
                                                <th scope="row">
                                                    <div class="media align-items-center">
                                                        <div class="media-body ml-4">
                                                            <a href="<?php echo e(route('projects.tasks.index', $due_task->project->id)); ?>"
                                                                class="name mb-0 h6 text-sm"><?php echo e($due_task->title); ?></a>
                                                        </div>
                                                    </div>
                                                </th>
                                                ...
                                                <td>
                                                    <span class="badge badge-dot mr-4">
                                                        <i
                                                            class="bg-<?php echo e(\App\Models\ProjectTask::$priority_color[$due_task->priority]); ?>"></i>
                                                        <span
                                                            class="status"><?php echo e(\App\Models\ProjectTask::$priority[$due_task->priority]); ?></span>
                                                    </span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span
                                                            class="completion mr-2"><?php echo e($due_task->taskProgress()['percentage']); ?></span>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mh-350 min-h-350">
                            <div class="card-wrapper table_scroll p-3">
                                <form method="post" id="form-todo" class="collapse pb-2"
                                    data-action="<?php echo e(route('todo.store')); ?>">
                                    <div class="card border shadow-none">
                                        <div class="px-3 py-2 row align-items-center">
                                            <div class="col-9">
                                                <input type="text" name="title" required class="form-control"
                                                    placeholder="<?php echo e(__('To do title')); ?>" />
                                            </div>
                                                    ...
                                                    <div class="col-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input"
                                                                ...
                                                                <?php echo e($todo->is_complete == 1 ? 'checked' : ''); ?>

                                                                data-url="<?php echo e(route('todo.update', $todo->id)); ?>">
                                                            <label class="custom-control-label h6 text-sm"
                                                                for="todo-item-<?php echo e($todo->id); ?>"><?php echo e($todo->title); ?></label>
                                                        </div>
                                                    </div>
                                                    <div
                                                        class="col-auto card-meta d-inline-flex align-items-center ml-sm-auto">
                                                        <a class="action-item d-todo" role="button"
                                                            data-url="<?php echo e(route('todo.destroy', $todo->id)); ?>">
...
<?php $__env->startPush('script'); ?>
    ...
    <?php else: ?>
        <script>
                ...
                if (title != '') {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            show_toastr('<?php echo e(__('Success')); ?>', '<?php echo e(__('To do Added Successfully!')); ?>',
                                'success');
                    ...
                    show_toastr('<?php echo e(__('Error')); ?>', '<?php echo e(__('Please write to do title!')); ?>', 'error');
                }
            });
            $(document).on("change", "#todolist input[type=checkbox]", function() {
                $.ajax({
                    ...
                    dataType: 'JSON',
                    success: function(data) {
                        show_toastr('<?php echo e(__('Success')); ?>', '<?php echo e(__('To do Updated Successfully!')); ?>',
                            'success');
                    },
                    error: function(data) {
                        data = data.responseJSON;
            ...
            $(document).on('click', '.d-todo', function() {
                ...
                $.ajax({
                    ...
                    dataType: 'JSON',
                    success: function(data) {
                        show_toastr('<?php echo e(__('Success')); ?>', '<?php echo e(__('To do Deleted Successfully!')); ?>',
                            'success');
            ...
            var t1 = {
                    ...
                    series: [{
                        name: "<?php echo e(__('Timesheet hours')); ?>",
        ...
        <script>
            (function() {
                var options = {
                    series: [<?php echo e(!empty($storage_limit) ? ($storage_limit) : ''); ?>],
                    chart: {
                        height: 475,
                        type: 'radialBar',
                        offsetY: -20,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/taskmagix/public_html/in/app/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>