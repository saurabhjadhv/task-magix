...
<?php $__env->startSection('action-button'); ?>
    ...
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-2" data-title="Filter" data-toggle="tooltip">
    ...
    <div class="dropdown btn btn-sm btn-white btn-icon-only rounded-circle ml-2 m-0 mb-2" data-title="Task Status" data-toggle="tooltip">
        <a href="#" class="action-item text-dark" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/tasks/taskboard.blade.php ENDPATH**/ ?>