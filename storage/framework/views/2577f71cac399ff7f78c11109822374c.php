...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <select name="ai_creativity" id="ai_creativity" class="form-select form-control px-3">
                ...
                <option value="0.5"><?php echo e(__('Medium')); ?></option>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::number('result_length',10,['class'=>'form-control', 'min'=>'0', 'onkeypress'=>'return event.charCode >= 48', 'placeholder'=>__('Enter maximum length of result')])); ?>
...
<?php /**PATH /home3/taskmagix/public_html/in/app/resources/views/generate.blade.php ENDPATH**/ ?>