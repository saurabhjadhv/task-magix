                            ...
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid <?php echo e($color); ?>;">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <strong data-v-4b3dcb8a="" class="sub-title"><?php if($invoice_usr->name): ?><?php echo e($invoice_usr->name); ?><?php endif; ?></strong>
                                        <pre data-v-4b3dcb8a=""><?php if($left_address['address']): ?><?php echo e($left_address['address']); ?><?php endif; ?></pre>
                                        <p data-v-4b3dcb8a=""><?php if($left_address['city']): ?> <?php echo e($left_address['city']); ?>, <?php endif; ?> <?php if($left_address['state']): ?><?php echo e($left_address['state']); ?><?php endif; ?> <?php if($left_address['zipcode']): ?> - <?php echo e($left_address['zipcode']); ?><?php endif; ?></p>
                                        <p data-v-4b3dcb8a=""><?php if($left_address['country']): ?> <?php echo e($left_address['country']); ?><?php endif; ?></p>
                                    </div>
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            <small data-v-4b3dcb8a=""><?php echo e(__('To')); ?>:</small>
                                            <strong data-v-4b3dcb8a="" class="sub-title"><?php if($invoice->client_id == $invoice_usr->id): ?>
                                                ...
                                                <?php endif; ?></strong>
                                            <pre data-v-4b3dcb8a=""><?php if($right_address['address']): ?><?php echo e($right_address['address']); ?><?php endif; ?></pre>
                                            <p data-v-4b3dcb8a=""><?php if($right_address['city']): ?> <?php echo e($right_address['city']); ?>, <?php endif; ?> <?php if($right_address['state']): ?><?php echo e($right_address['state']); ?><?php endif; ?> <?php if($right_address['zipcode']): ?> - <?php echo e($right_address['zipcode']); ?><?php endif; ?></p>
                                            <p data-v-4b3dcb8a=""><?php if($right_address['country']): ?> <?php echo e($right_address['country']); ?><?php endif; ?></p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right"><?php echo e(\App\Models\Utility::invoiceNumberFormat($invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb"><?php echo e(__('Project')); ?>:</td>
                                                <td data-v-4b3dcb8a="" class="text-right"><?php echo e($invoice->project->title); ?></td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb"><?php echo e(__('Due Date')); ?>:</td>
                                                <td data-v-4b3dcb8a="" class="text-right"><?php echo e(\Utility::getDateFormated($invoice->due_date)); ?></td>
                                            </tr>
                                ...
                                <div data-v-4b3dcb8a="" class="d-table">
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="tu d-table-tr" style="background: <?php echo e($color); ?>; padding: 5px;color: <?php echo e($font_color); ?>">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-th w-5"><?php echo e(__('Price')); ?></div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-3 text-right"><?php echo e(__('Tax')); ?></div>
                                        </div>
                                                ...
                                                <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-13">
                                                            <pre data-v-4b3dcb8a=""><?php echo e($item->item); ?><br data-v-4b3dcb8a=""></pre>
                                                        </div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-5"><span data-v-4b3dcb8a=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true)); ?></span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right"><span data-v-4b3dcb8a=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true)); ?></span></div>
                                                    </div>
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)); ?></div>
                                                </div>
                                                <?php if($invoice->getTax()): ?>
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label"><?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a=""><?php echo e(__('Total')); ?>:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)); ?></strong></div>
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH D:\Main Projects\TaskMagix\in\app\resources\views/invoices/templates/template6.blade.php ENDPATH**/ ?>