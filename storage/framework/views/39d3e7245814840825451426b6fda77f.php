                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-2 text-right">
                                        <p data-v-37eeda86=""><?php if($invoice_usr->name): ?><?php echo e($invoice_usr->name); ?><?php endif; ?></p>
                                        <p data-v-37eeda86="">
                                ...
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-66">
                                        ...
                                        <p>
                                            <?php if($invoice->client_id == $invoice_usr->id): ?>
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                        ...
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right"><?php echo e($invoice->project->title); ?></td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu"><?php echo e(__('Due Date')); ?>:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right"><?php echo e(\Utility::getDateFormated($invoice->due_date)); ?></td>
                                            </tr>
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr" style="color: <?php echo e(($color == '#ffffff') ? 'black': $color); ?>; border-bottom: 1px solid <?php echo e($color); ?>; border-top: 1px solid <?php echo e($color); ?>;">
                                            ...
                                            <div class="d-table-th w-4 text-right"><?php echo e(__('Tax')); ?></div>
                                        </div>
                                                ...
                                                <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="d-table-tr" style="border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div class="d-table-td w-5">
                                                            <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true)); ?></pre>
                                                        </div>
                                                        <div class="d-table-td w-4 text-right"><span><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true)); ?></span></div>
                                                    </div>
                                        ...
                                        <div data-v-37eeda86="" class="d-table-footer">
                                            ...
                                            <div class="d-table-summary">
                                                <div class="d-table-summary-item">
                                                    ...
                                                    <div
                                                        class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)); ?></div>
                                                </div>
                                                <?php if($invoice->getTax()): ?>
                                                    <div class="d-table-summary-item">
                                                        <div class="tu d-table-label">
                                                            <?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):
                                                        </div>
                                                        <div class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)); ?></div>
                                                    </div>
                                                <?php endif; ?>
                                                <div class="d-table-summary-item"
                                                    ...
                                                    <div class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)); ?></div>
                                                </div>
                                                <div class="d-table-summary-item"
                                                     style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    <div class="tu d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                    <div class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)); ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php /**PATH D:\Main Projects\TaskMagix\in\app\resources\views/invoices/templates/template2.blade.php ENDPATH**/ ?>