        ...
        <div class="card shadow zindex-100 mb-0">
            <div class="card-body px-md-5 py-5">
                <div class="mb-4">
                    ...
                    <p class="text-muted mb-0"><?php echo e(__('Login to your account to continue.')); ?></p>
                </div>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter Email Address" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus/>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(Route::has('password.request')): ?>
                                <div class="mb-2 text-right">
                                    <a href="<?php echo e(route('password.request',$lang)); ?>" class="small text-muted text-underline--dashed border-primary"><?php echo e(__('Forgot password?')); ?></a>
                                </div>
                            <?php endif; ?>
                        <div class="my-4">
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(\App\Models\Utility::getValByName('SIGNUP') == 'on'): ?>
                <div class="card-footer px-md-5"><small><?php echo e(__('Not registered?')); ?></small>
                    <a href="<?php echo e(route('register',$lang)); ?>" class="small font-weight-bold"><?php echo e(__('Register')); ?></a>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/taskmagix/public_html/in/app/resources/views/auth/login.blade.php ENDPATH**/ ?>