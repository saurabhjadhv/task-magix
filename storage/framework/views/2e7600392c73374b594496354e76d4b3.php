                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        ...
                                        <p data-v-f2a183a6=""><?php if($invoice_usr->name): ?><?php echo e($invoice_usr->name); ?><?php endif; ?></p>
                                        <p data-v-f2a183a6="">
                                                    ...
                                                    <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($border_color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price)); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5 text-right">
                                                                <pre data-v-f2a183a6=""><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax())); ?></pre>
                                                            </div>
                                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($invoice->getTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH D:\Main Projects\TaskMagix\in\app\resources\views/invoices/templates/template1.blade.php ENDPATH**/ ?>