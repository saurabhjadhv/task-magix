                            ...
                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <span class="h6 text-sm font-weight-bold mb-0"><a
                                                href="<?php echo e(route('projects.tasks.index', $task->project->id)); ?>"><?php echo e($task->title); ?></a></span>
                                        <span class="d-block text-sm text-muted"><?php echo e($task->project->title); ?>

                                            <span
                                                class="badge badge-xs badge-success"><?php echo e(__(\Auth::user()->checkProject($task->project_id))); ?></span>
                                        </span>
                                    </td>
                                    <td><?php echo e($task->stage->name); ?></td>
                                    <td>
                                        <span
                                            class="badge badge-pill badge-sm badge-<?php echo e(__(\App\Models\ProjectTask::$priority_color[$task->priority])); ?>"><?php echo e(__(\App\Models\ProjectTask::$priority[$task->priority])); ?></span>
                                    </td>
                                    <td class="<?php echo e(strtotime($task->end_date) < time() ? 'text-danger' : ''); ?>">
                                        <?php echo e(\App\Models\Utility::getDateFormated($task->end_date)); ?></td>
                                    <td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <span
                                            class="completion mr-2"><?php echo e($task->taskProgress()['percentage']); ?></span>
                                    </div>
                                </td>
...
<?php /**PATH /home3/taskmagix/public_html/in/app/resources/views/tasks/list.blade.php ENDPATH**/ ?>