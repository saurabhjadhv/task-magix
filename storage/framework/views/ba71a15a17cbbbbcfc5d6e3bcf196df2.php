                ...
                <div class="col-12">
                    <div class="footer pt-1 pb-4 footer-light" id="footer-main">
                        <div class="row text-center align-items-sm-center">
                            <div class="col-sm-12">
                                <p class="text-colr">&copy; <?php echo e(date('Y')); ?>

                                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Task Magix')); ?>.
                                    All Rights Reserved. One XL Info LLP</p>
...
<?php /**PATH D:\Main Projects\TaskMagix\in\app\resources\views/layouts/auth.blade.php ENDPATH**/ ?>